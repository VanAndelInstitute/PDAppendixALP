---
title: "Brain Age Acceleration, OFB, Padlocks, CGonly"
output:
  html_document:
    toc: true
    toc_depth: 2
...
params <- list(
  ...
  model = list(
    formula = "~ 0 + Group + Group:Age + Gender + PMI",
    formula0= "~ 0 + Group + Age + Gender + PMI",
    contrasts = c("GroupCTRL.Age", "GroupPD.Age", "GroupCTRL.Age - GroupPD.Age"),
    nsv = 0
  )
)
```
...
```{r}
methylation <- methylation[1:1000,]
```
