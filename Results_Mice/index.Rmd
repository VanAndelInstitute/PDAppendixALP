...
```{r, include=TRUE, fig.height=3, fig.cap="**Figure S13. Manhattan plot demonstrating differential methylation in the A30P α-syn overexpression model that experienced DSS-induced gut inflammation. There were 408 genes in the ALP exhibiting differential methylation in A30P α-syn mice exposed to DSS colitis, relative to A30P α-syn mice that did not experience DSS colitis (1,378 sites at q < 0.05, robust linear regression). ALP genes implicated in both our study and PD risk by GWAS [23] (mapped to corresponding mouse genes) are labeled. SLP refers signed log p-value, with sign corresponding to the direction of DNA methylation change (hypermethylation, green or hypomethylation, blue).**"}
...
```{r, include=TRUE, fig.cap="**Figure S14. Differential methylation of the ALP in the cecal patch of A30P α-syn mice.**"}
...
```{r, include=TRUE, fig.cap="**Figure S15. Differential methylation of the ALP in the cecal patch of mice with $\alpha$-syn aggregation. **"}
...
```{r, include=TRUE, fig.cap="**Figure S16. ALP pathway changes in the PD appendix compared to the mouse studies.**"}
p1
```

Overlap of findings in appendix, A30P and DSS mice
