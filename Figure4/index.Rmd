...
pF <- 
  ...
  geom_segment(
   ...
   geom_point(
    aes(x = X, y = Healthy, color = "Control aging"), size = 0.25) +
  geom_point(
    aes(x = X, y = PD, color = "PD aging"), size = 0.25) +
   geom_text_repel(
      data = function(x) x[Gene %in% geneList],
  ...
  scale_color_manual("", values = c(`Control aging` = '#0080FF', `PD aging` = '#FF00FF')) + 
  theme_publication() + 
  theme(
...
ggdraw() +
  ...
  draw_plot_label(
    label = c(letters[1:7]),
    size = 10,
    x = c(0, 0.3, 0.6, 0,    0,    0.28,  0.28),
    y = c(1, 1,   1,   0.59, 0.42, 0.59, 0.42))
